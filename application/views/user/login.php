 <div class="site-wrap">
     ...
     <div class="bg-light py-3">
         <div class="container">
             <div class="row">
             <div class="col-md-12 mb-0"><a href="/">Главная</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Вход</strong></div>
             </div>
         </div>
     </div>
     ...
     <div class="site-section">
         <div class="container">
             ...
             <div class="col-md-6 mb-5 mb-md-0">
                    <h2 class="h3 mb-3 text-black">Вход</h2>
                        ...
                        <form action="/user/login/" method="post">
                            <div class="form-group row">
                                <div class="col-md-6">
                                    ...
                                    placeholder="test@gmail.com" title="test@gmail.com" name="email" value="">
