    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 mb-0">
                ...
                <strong class="text-black">Удалить товар</strong></div>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <h2 class="display-3 text-black">Удалить товар #<?php echo $id; ?></h2>
                <form method="post">
                    <div class="col-md-6">
                        <div class="row mb-5">
                            <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="row mb-5">
                        <div class="col-md-6">
                            <a href="/admin/category" class="btn btn-outline-primary btn-sm btn-block">Товары</a>
                        </div>
                    </div>
                </div>
            </div>
